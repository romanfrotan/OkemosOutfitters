...
class PartTest {
    ...
    void setMinInventory() {
        int inv=1;
        partIn.setMinInventory(inv);
        assertEquals(inv,partIn.getMinInventory());
        partOut.setMinInventory(inv);
        assertEquals(inv,partOut.getMinInventory());
    }
    @Test
    void setMaxInventory() {
        int inv=999;
        partIn.setMaxInventory(inv);
        assertEquals(inv,partIn.getMaxInventory());
        partOut.setMaxInventory(inv);
        assertEquals(inv,partOut.getMaxInventory());
    }
